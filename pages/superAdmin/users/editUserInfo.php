					...
					<div class="card-body text-dark">
						<div class="container-fluid">
							<div class="row">
									...
									<div class="blog-widget blog-image">
										<div class="card-body" style="background: url('../../../assets/img/back.png') center center no-repeat">
											...
											<div class='text-center  blog-image'>
												<img class='el-card-avatar rounded-circle' style='height: auto; width: 150px;' src='../../../assets/img/uploads/profile".$_SESSION['username'].".jpg?'".mt_rand().">
											</div>
											<form method='post' class='text-left' enctype='multipart/form-data' action='../../../validation/superAdmin/users/deleteProfileImage.php'>
												<div class='col-md-12 '>
													<div class='form-group'>
														...
														<input type='hidden' name='c_userName' value='".$_SESSION['username']."'>
														<input type='hidden' name='c_userId' value='".$_SESSION['user_id']."'>
													</div>
												</div>
								...
								<div class="col-md-8">
									<form id="editUserForm" name="editUserForm" method="post" action="../../../validation/superAdmin/users/editUserInfo.php" class="needs-validation " novalidate>
										<div class="form-row form-material">
											<div class="col-md-6 mb-3">

												<input type="hidden" class="form-control" id="u_id" name="u_id" required value="<?php echo $_SESSION['user_id']?>">
										...
										<div class="form-row form-material">
											<div class="col-md-6 mb-3">
												...
												<select id="editUserType" name="editUserType" class="custom-select form-control"  required>
													<option value="<?php echo $_SESSION['u_type']?>"><?php echo $_SESSION['u_type']?></option>
						...
						<!-- File sizer to big-->
						<?php if (isset($_GET['file_size'])) { ?>
							<div class="alert alert-danger alert-dismissable col-sm-12 text-center">
								<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
								<?php echo $_GET['file_size'];?>
							</div>
						<?php } ?>


						<!-- error_uploading-->
						<?php if (isset($_GET['error_uploading'])) { ?>
							<div class="alert alert-danger alert-dismissable col-sm-12 text-center">
								<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
								<?php echo $_GET['error_uploading'];?>
							</div>
						<?php } ?>
						...
						<!-- empty_file-->
						<?php if (isset($_GET['empty_file'])) { ?>
							<div class="alert alert-danger alert-dismissable col-sm-12 text-center">
								<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
								<?php echo $_GET['empty_file'];?>
							</div>
						<?php } ?>

						<!-- image_delete Success-->
						<?php if (isset($_GET['image_delete'])) { ?>
							<div class="alert alert-danger alert-dismissable col-sm-12 text-center">
								<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
								<?php echo $_GET['image_delete'];?>
							</div>
						<?php } ?>
